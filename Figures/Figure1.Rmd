...
codex <-  readRDS()#Available in the source data of the manuscript
...
## D
```{r Panel D}
#tmp_csv: output from nhood analysis script found here: https://github.com/ZauggGroup/LNarch/edit/main/Preprocessing/Figure1_NhoodAnalysis.py
tmp_csv <- read.csv("AllSamples_sliding_withK.csv", row.names = 1)
