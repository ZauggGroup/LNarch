...
## B
## Note that for SCENIC output you can directly read targene_df from Zenodo as GRN_90pt.rds
## The following ˜20 lines illustrate how to preprocess the SCENIC output in order to get a network (ie what is in Zenodo)
