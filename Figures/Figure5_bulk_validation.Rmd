...
- Survival data from Löffler-Wirth et al. 2019 was kindly provided by Hans Binder and team (source data for all figures generated in this manuscript are provided; please contact our corresponding authors for full data access)
- Survival data from Lenz et al. 2008 and Reddy et al. 2017 was kindly provided by Georg Lenz and team (ource data for all figures generated in this manuscript are provided; please contact our corresponding authors for full data access)
...
CIBERSORTx was run in the web application using 
perm: 500
verbose: TRUE
QN: TRUE
